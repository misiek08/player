package com.shen.player.view.ui.video {
	
	import com.shen.core.geom.Size;
	import com.shen.core.util.Util;
	import com.shen.player.model.constant.VideoScaleMode;
	...
	public class VideoBox extends Sprite {
		...
		private function scaleImage(width:Number, height:Number):void {
			if(img) {
				var size:Size = Util.scaleToClip(img.originalWidth, img.originalHeight, width, height);
